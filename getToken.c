...
/**getToken function sets two character pointers
 * @Param:  char **tokBegin - beginning of a token
 *          char **tokEnd  - first character beyond
...
/* post-condition: if tokBegin or *tokBegin was NULL when getToken was
